...
class BoundingBox:
    ...
    def intersects(self, o):
        return (self.x < o.x + o.w and self.y < o.y + o.h and self.x + self.w > o.x and self.y + self.h > o.y)
...
class Tile:
    ...
    def _split(self, image, limit):
        ...
        #cropping
        #first parameter=left
        #second paramter=top
        #third parameter=right
        #fourth paramter=bottom
